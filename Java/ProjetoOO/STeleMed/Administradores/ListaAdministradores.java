...
public class ListaAdministradores implements ColecaoDeUsuarios {
    ...
    public void cadastrarPrimeiroAdm(Administrador administrador) {
        ...
        this.totalDeAdministradores++;
        System.out.println("Administrador Mestre cadastrado com sucesso!");
    }
    ...
    public void gerenciarUsuario() {
        ...
        do {
            ...
            System.out.println("4 - Exibir Administradores do Sistema");
    ...
    public void cadastrarUsuario() {
        ...
        Administrador administrador = new Administrador(nome, cpf, telefone, endereco, email, senha, funcao);
    ...
    public void excluirUsuario() {
        ...
        if (this.inicial != null) {
            ...
            if (atual != null && atual.obterAdministrador().getEmail().equals(emailBuscado)) {
                System.out.print("Tem certeza que deseja excluir o administrador: " + atual.obterAdministrador().getEmail() + " ? (sim/não): ");
            ...
            System.out.println("\nNão existe nenhum Administrador cadastrado no sistema\n\n");
        }
    }
    ...
    public String visualizarCadastros() {
        ...
        while (atual != null) {
            elementos += "IdUser: " + atual.obterAdministrador().getId_user() + "\n"
            + "IdAdm: " + atual.obterAdministrador().getIdAdm() + "\n"
            + "Nome: " + atual.obterAdministrador().getNome() + "\n"
            + "CPF: " + atual.obterAdministrador().getCpf() + "\n"
            + "Telefone: " + atual.obterAdministrador().getTelefone() + "\n"
            + "Endereço: " + atual.obterAdministrador().getEndereco() + "\n"
            + "Email: " + atual.obterAdministrador().getEmail() + "\n"
            + "Função: " + atual.obterAdministrador().getFuncao() + "\n"
            + "---------------------------\n";
            atual = atual.obterProximo();
        }
